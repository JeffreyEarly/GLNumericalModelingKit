...
Let's say we as for a grid with min 0, max 12---with four points. An endpoint grid, creates points at 0,4,8,12. An interior grid creates points at 1.5, 4.5, 7.5, 10.5. A periodic grid creates points at 0, 3, 6, 9.
